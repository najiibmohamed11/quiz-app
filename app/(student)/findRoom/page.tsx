    ...
    <Card className='w-80'>
        ...
        <CardContent className=' m-0'>
            <form action="submit" onSubmit={onSubmit}>
                ...
                <Input value={roomName} id='roomName' type='text' placeholder='Enter Room Name' onChange={(e)=>setRoomName(e.target.value)}/>
                <p className='text-red-700'>{error&&error}</p>
                <Button disabled={isLoading||!roomName} type='submit' className='mt-8 w-full'>  {isLoading ? "Loading..." : "Find Room"}</Button>
            </form>
        </CardContent>
